...
const Cv = ({ FadeInSection }) => {
    ...
    return (
        <div style={{
            ...
            <div className="cv">
                <a href="https://drive.google.com/file/d/1bLXNSAkEyI53qRs855j3KiJU1uDTdLLt/view?usp=sharing_link" target="_blank">
                    <StaticImage
                        src="../images/cv.svg"
                        quality={95}
                ...
                <div className="cvText">
                    ...
                    <div className="employments">
                        <div><FadeInSection>
                            ...
                            <FadeInSection>
                                <h4>Project Manager Web Design and Development</h4>
                            </FadeInSection>
                        </div>
                    </div>
